  ...
  <div class="container">
    ...
    <form method="POST" action="">
      <div class="form-group">
        ...
        <input type="text" id="username" name="username" class="input-field" placeholder="Enter your username or email" required autocomplete="username">
      </div>
