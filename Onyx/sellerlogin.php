...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  // Fetch id, password, and role from database
  ...
  if ($user = $result->fetch_assoc()) {
    if ($user['role'] != 1) {
      $error = "User not found"; // Not a seller
    } elseif ($password === $user['password']) { // For better security, use password_verify()
...
<body>
  <div class="container">
    ...
    <p class="register-link">Don't have an account? <a href="register_seller.php">Register here</a></p>
  </div>
</body>
</html>
